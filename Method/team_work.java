...
class Test
{
	...
	{
		//Scanner sc =new Scanner(System.in);
		//System.out.println("How many lines do you want to ennter");
		//int n =sc.nextInt();
	...
	do
	{
		...
		switch(choice)
		{
			case 1:
				this.Pattern1(n);
				break;
			case 2:this.Pattern2(n);
			break;
			case 3:this.Pattern3(n);
			break;
			case 4:this.Pattern4(n);
			break;
			case 5:this.Pattern5(n);
			break;
			case 6:this.Pattern6(n);
			break;
			case 7:this.Pattern7(n);
			break;
			case 8:this.Pattern8(n);
			break;
			case 9:this.Pattern9(n);
			break;
			case 10:this.Pattern10(n);
			break;
			case 11:x=false;
			break;
			default:System.out.println("Press Again");
			break;
		}
	}while(x);
