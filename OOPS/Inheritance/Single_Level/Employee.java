...
class Employee
{
	...
	int id;
	double bounus;
	public void setData(String name,double salary,int id,double bounus)
	{
		this.name=name;
		this.salary=salary;
		this.id=id;
	...
	public void getEmp()
	{
		System.out.println("The name of Manager Is "+this.name);
		...
		System.out.println("The Bounus Amount  of "+this.name +"Is "+this.bounus);
...
class Manager extends Employee
{
	...
	{
		getEmp();
		System.out.println("The Work  of "+this.name +"Is "+this.work);
	}
}
class Test
{
